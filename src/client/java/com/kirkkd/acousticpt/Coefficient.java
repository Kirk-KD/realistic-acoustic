...
public class Coefficient {
    ...
    private static final Map<TagKey<Block>, Pair<Double, Double>> VALUES = Map.of(
            BlockTags.LEAVES, new Pair<>(0.10, 0.7),

            BlockTags.PICKAXE_MINEABLE, new Pair<>(0.9, 0.1),
            BlockTags.AXE_MINEABLE, new Pair<>(0.55, 0.4),
            BlockTags.SHOVEL_MINEABLE, new Pair<>(0.25, 0.3),
